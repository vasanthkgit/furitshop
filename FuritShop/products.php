...
<body style="background-image: url('images/background2.jpg'); !important">
  ...
  <div class="container ">
    <h1 class="text-center font-80px margin-bottom50"> <b>Welcome <?php echo $_SESSION['name']; ?>! Order the Best and Tastiest Fruits</b></h1>
        ...
        <div class="row">
          ...
          <div class="col-md-12 bio-tab">
            <div class="row">
              ...
              <div class="col-md-8">
                <h1 class="text-center"> <b>About FruitShop.com</b> </h1>
                <p>&nbsp&nbsp&nbsp&nbsp<b><i>India’s Ultimate Online Fresh Fruit Shopping Site <b>FruitShop</b>’s vision is to create India’s most reliable and frictionless commerce ecosystem that creates life-changing experiences for buyers and sellers.<b>FruitShop.com</b> is India’s largest online Fruit shopping marketplace. A Boon The trend of online shopping is becoming a household name and so is FruitShop.</i></b></p>  
              </div>
            </div>
          </div>
